...
public class SettingsActivity extends PreferenceActivity {
	...
	private void setupSimplePreferencesScreen() {
		...
		fakeHeader = new PreferenceCategory(context);
		fakeHeader.setTitle(R.string.pref_header_map);
		getPreferenceScreen().addPreference(fakeHeader);
		addPreferencesFromResource(R.xml.pref_map);
		
		bindPreferenceSummaryToValue(findPreference("intervallo_acquisizione"));
		bindPreferenceSummaryToValue(findPreference("intervallo_send"));
		bindPreferenceSummaryToValue(findPreference("ore_ultime_attivita"));
		bindPreferenceSummaryToValue(findPreference("modalita_percorsi"));
		bindPreferenceSummaryToValue(findPreference("zoom_level"));
		bindPreferenceSummaryToValue(findPreference("map_mode"));
		bindPreferenceSummaryToValue(findPreference("map_color"));
	}
